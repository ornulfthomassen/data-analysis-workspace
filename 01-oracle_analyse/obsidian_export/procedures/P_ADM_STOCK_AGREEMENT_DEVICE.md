...
## Description
Rebuilds the `CLM_ADM.ADM_STOCK_AGREEMENT_DEVICE_ALL` table by consolidating and transforming detailed data related to device agreements, subscriptions, products, customer information, and IMEI usage from various source systems. It derives several status indicators and descriptive fields, and then grants select privileges and computes statistics on the newly created table.
...
- → [[ADM_STOCK_AGREEMENT_DEVICE_ALL]]
| Column Name |
|---|
| LOAD_DATE |
| AGREEMENT_OFFER_NAME |

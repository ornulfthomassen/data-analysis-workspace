# KIM_CONTACT_ORDER_MATCH_7_N

**Schema:** `CRM_ANALYSE` | **Type:** `Procedure`

## Description
This procedure identifies and matches orders to campaign contacts based on complex criteria involving product categories, order dates, and customer household IDs. It uses a temporary table for intermediate data processing and then updates the main campaign detail fact table (`KIM_CAMPAIGN_DETAIL_FACT`) with the matched order information. It also logs job status and metrics to governance and logging tables.

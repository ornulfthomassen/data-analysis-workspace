...
- ← [[CCM.SUBSCRIPTION_DIM_MV]]
| Column Name |
|---|
| MAIN_NUMBER |
| SUBSCRIPTION_KEY |

- ← [[CCM.SUBSCR_USER_DIM_V]]
| Column Name |
|---|
| USER_CUSTOMER_KEY |

- ← [[CCM.ORDER_LINE_PRODUCT_DIM_V]]
| Column Name |
|---|
| PRODUCT_NAME |
| PRODUCT_DESC |
...
- ← [[CCM.SALES_ORDER_INDICATOR_DIM_MV]]
| Column Name |
|---|

...
## Description
Aggregates monthly mobile subscription usage and revenue data, consolidating information for 'twin' subscriptions (sub-accounts) to provide a unified view per main subscription. This view is utilized for loading revenue data into Mjøsa.

# VYA_ADM_TWIN_USAGE_MONTH_AGG_D

**Schema:** `CCM` | **Type:** `View`

## Description
This view transforms and presents monthly aggregated mobile usage data, including MMS, SMS, voice calls (TALE), and data usage (MB_DATA), categorized by domestic, international EU, international ROW, and roaming EU/ROW. It formats period and subscription identifiers and applies a filter for valid subscription numbers. This view likely serves administrative or analytical reporting on telecommunications usage.

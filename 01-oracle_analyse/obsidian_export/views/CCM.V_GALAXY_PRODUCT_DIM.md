# V_GALAXY_PRODUCT_DIM

**Schema:** `CCM` | **Type:** `View`

## Description
Creates a dimension view for product information, projecting all columns directly from the GALAXY.PRODUCT_DIM table for potential schema separation or specific application access.

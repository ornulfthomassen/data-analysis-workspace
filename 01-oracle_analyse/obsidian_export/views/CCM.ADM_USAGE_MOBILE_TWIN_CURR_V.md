# ADM_USAGE_MOBILE_TWIN_CURR_V

**Schema:** `CCM` | **Type:** `View`

## Description
This view aggregates mobile usage data (MMS, SMS, calls/Tale, and data volume/MB_DATA) and associated net revenues for TWIN and DATATWIN subscriptions for the current month. It summarizes these metrics by period month key, subscription ID, and sub-number.

# ADM_USAGE_MOBILE_MONTH_V

**Schema:** `CCM` | **Type:** `View`

## Description
Aggregates detailed mobile usage statistics and associated net revenues (for MMS, SMS, Voice, and Data) by subscription and month, typically for the current and last five months, joining monthly dimension data with aggregated subscription usage records.

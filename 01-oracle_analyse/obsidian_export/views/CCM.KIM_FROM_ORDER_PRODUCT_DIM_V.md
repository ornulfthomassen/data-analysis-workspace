# KIM_FROM_ORDER_PRODUCT_DIM_V

**Schema:** `CCM` | **Type:** `View`

## Description
This view, 'KIM_FROM_ORDER_PRODUCT_DIM_V', serves as a direct passthrough or alias for the 'FROM_ORDER_PRODUCT_DIM_V' view located in the 'GALAXY' schema, making its product dimension data available within the 'CRM_ANALYSE' schema without any transformations or filtering.

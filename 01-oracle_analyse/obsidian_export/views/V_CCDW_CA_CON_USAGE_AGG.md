# V_CCDW_CA_CON_USAGE_AGG

**Schema:** `CCM` | **Type:** `View`

## Description
This view serves as a direct projection or wrapper for the `CON_USAGE_AGG` table, exposing aggregated consumer usage data without any transformations or filtering. It likely provides a standardized interface or schema alias for the underlying aggregated usage statistics.

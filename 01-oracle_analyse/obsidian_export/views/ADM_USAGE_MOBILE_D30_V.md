# ADM_USAGE_MOBILE_D30_V

**Schema:** `CCM` | **Type:** `View`

## Description
Aggregates mobile usage and revenue metrics (MMS, SMS, voice calls, and data) for subscriptions, specifically filtering for a `PERIOD_MONTH_KEY` equal to 30. It provides a summarized view of various usage and revenue categories.

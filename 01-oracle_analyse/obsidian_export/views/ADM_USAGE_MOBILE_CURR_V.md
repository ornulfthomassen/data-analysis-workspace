# ADM_USAGE_MOBILE_CURR_V

**Schema:** `CCM` | **Type:** `View`

## Description
Provides aggregated subscription usage information for the current month, including details on MMS, SMS, calls (TALE), and mobile data (MB_DATA) usage and associated net revenue. This view is used by CLM_CCM (SAS IMM&BI).

# KIM_CONTACT_PRODUCT_DIM_V

**Schema:** `CCM` | **Type:** `View`

## Description
Creates a product dimension view, `KIM_CONTACT_PRODUCT_DIM_V`, by selecting all product-related attributes from the `GALAXY.PRODUCT_DIM` table. It renames the `PRODUCT_KEY` column to `CONTACT_PRODUCT_KEY` and keeps all other columns with their original names.

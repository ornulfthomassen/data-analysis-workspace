...
## Description
This view provides a consolidated monthly summary of subscription usage and revenue data. Its main purpose is to present data for a single subscription as a whole, addressing complexity arising from 'twin' subscriptions. It is involved in loading consumption and revenue data to Mjøsa.

# KS_INTERACTION_ORDERMATCH_F_V

**Schema:** `CCM` | **Type:** `View`

## Description
This view consolidates data from three underlying views (KS_INTERACTION_ORDERMATCH_C_V, KS_INTERACTION_ORDERMATCH_D_V, and KS_INTERACTION_ORDERMATCH_E_V) using a UNION ALL operation. It creates a unified dataset of interaction and order matching details, adding a 'TABL' column to indicate the original source category ('Match', 'Interactions', or 'Orders') for each record. This allows for a comprehensive analysis across different segments of interaction and order data.

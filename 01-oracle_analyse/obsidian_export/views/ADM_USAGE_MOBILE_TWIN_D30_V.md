...
## Description
Provides aggregated mobile usage information (MMS, SMS, Voice, Data revenue and counts) for subscriptions, specifically related to TWIN and DATATWIN services, for a specific period (PERIOD_MONTH_KEY = 30). The data is aggregated by period month key, subscription ID, and sub number.

# GCP_SUBS_USAGE_MONTH_CURR

**Schema:** `CCM` | **Type:** `View`

## Description
Provides a filtered view of mobile subscription usage and revenue data for a specific period (identified by PERIOD_MONTH_KEY = 999912), including details on MMS, SMS, call minutes, and data consumption, broken down by domestic, international, and roaming categories.

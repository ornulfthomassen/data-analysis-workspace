...
## Description
This view consolidates interaction and order matching data by performing a UNION ALL operation across three underlying views: KS_INTERACTION_ORDERMATCH_A_V, KS_INTERACTION_ORDERMATCH_B_V, and KS_INTERACTION_ORDERMATCH_B2_V. It combines all columns from these sources into a single, unified dataset for analysis.

## Data Sources (Inputs)
- ← [[CCM.KS_INTERACTION_ORDERMATCH_A_V]]
| Column Name |
|---|
| START_CAL_DATE |
| END_CAL_DATE |
...
- ← [[CCM.KS_INTERACTION_ORDERMATCH_B_V]]
| Column Name |
|---|
| START_CAL_DATE |
| END_CAL_DATE |
...
- ← [[CCM.KS_INTERACTION_ORDERMATCH_B2_V]]
| Column Name |
|---|
| START_CAL_DATE |
| END_CAL_DATE |
